...
contract ArraysContract {
    ...
    function testArray() public {
        ...
        // Explicit conversion is needed for unit8 to int8
        ...
        /*
            MIMP:   
                We cannot define memory arrays outside functions, 
                outside functions array are by default going to be stored in storage type.
        */
        ...
        // Assignment to the dynamic memory array NOT allowed
        // dynamicMemoryArray = [uint8(1),2,3];
        ...
        /** 
            Examples of array initialization with assignment
         */        
        // Static storage array assignment is OK
        // Compile time size check is carried out so assignment to [1,2,3,4] will fail below
        staticIntArray = [1,2,3];

        // Static memory array
        uint[2] memory staticMemoryArray;

        // This is allowed - make sure the type is matching - staticMemoryArray is type of unit
